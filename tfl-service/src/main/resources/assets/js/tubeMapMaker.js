...
function addStations() {
    ...
    addStation(LINE_CIRCLE, LADBROKE_GROVE, "692", "705");
    ...
    addStation(LINE_HAMMERSMITH, LATIMER_ROAD, "665", "723");
    addStation(LINE_HAMMERSMITH, LADBROKE_GROVE, "687", "701");
    addStation(LINE_HAMMERSMITH, WESTBOURNE_PARK, "705", "684");
    addStation(LINE_HAMMERSMITH, ROYAL_OAK, "729", "659");
    addStation(LINE_HAMMERSMITH, PADDINGTON_2, "804", "641.01");
    addStation(LINE_HAMMERSMITH, EDGWARE_ROAD_1, "903", "641.01");
    addStation(LINE_HAMMERSMITH, BAKER_STREET, "1048", "641.01");
    addStation(LINE_HAMMERSMITH, GREAT_PORTLAND_STREET, "1132", "641.01");
    addStation(LINE_HAMMERSMITH, EUSTON_SQUARE, "1266", "641.01");
    addStation(LINE_HAMMERSMITH, KINGS_CROSS, "1356", "641.01");
    addStation(LINE_HAMMERSMITH, FARRINGDON, "1416", "675");
    addStation(LINE_HAMMERSMITH, BARBICAN, "1453", "711");
    addStation(LINE_HAMMERSMITH, MOORGATE, "1483", "731.9");
    addStation(LINE_HAMMERSMITH, LIVERPOOL_STREET, "1588", "731.9");
...
function addConnections() {
    ...
    joinStation(LINE_HAMMERSMITH, WOOD_LANE, LATIMER_ROAD, "660.29 737.93 C 660.29 733.06 663.11 726.26 666.55 722.81");
    ...
    joinStation(LINE_HAMMERSMITH, ROYAL_OAK, PADDINGTON_2, "740.08 649.28 C 745.42 643.94 752.52 641.01 760.07 641.01");
    ...
    joinStation(LINE_HAMMERSMITH, KINGS_CROSS, FARRINGDON, "1371.43 641.01 C 1378.98 641.01 1386.08 643.95 1391.42 649.28");
    joinStation(LINE_HAMMERSMITH, FARRINGDON, BARBICAN);
    joinStation(LINE_HAMMERSMITH, BARBICAN, MOORGATE, "1469.68 727.53 C 1472.51 730.35 1476.26 731.9 1480.26 731.9");
    joinStation(LINE_HAMMERSMITH, MOORGATE, LIVERPOOL_STREET);
    joinStation(LINE_HAMMERSMITH, LIVERPOOL_STREET, ALDGATE_EAST, "1630.01 731.9 C 1637.56 731.9 1644.66 734.85 1650 740.17 L 1650 740.17 C 1655.34 745.52 1658.27 752.61 1658.27 760.16 L 1658.27 760.16 C 1658.27 768.34 1658.27 806.11 1658.27 806.11 L 1658.27 806.11 C 1658.27 811.64 1660.38 817.17 1664.6 821.38 L 1664.6 821.38 L 1672.19 828.94 L 1672.19 828.94 C 1676.93 833.68 1680.07 836.05 1686.28 836.05 L 1686.28 836.05 S 1698.71 833.68 1703.45 828.94");
