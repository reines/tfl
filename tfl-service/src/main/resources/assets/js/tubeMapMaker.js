...
function addStations() {
    ...
    addStation(LINE_DISTRICT, UPMINSTER, "", "");
    addStation(LINE_DISTRICT, UPMINSTER_BRIDGE, "", "");
    addStation(LINE_DISTRICT, HORNCHURCH, "", "");
    addStation(LINE_DISTRICT, ELM_PARK, "", "");
    addStation(LINE_DISTRICT, DAGENHAM_EAST, "", "");
    addStation(LINE_DISTRICT, DAGENHAM_HEATHWAY, "", "");
    addStation(LINE_DISTRICT, BECONTREE, "", "");
    addStation(LINE_DISTRICT, UPNEY, "", "");
    addStation(LINE_DISTRICT, BARKING, "", "");
    addStation(LINE_DISTRICT, EAST_HAM, "", "");
    addStation(LINE_DISTRICT, PLAISTOW, "", "");
    addStation(LINE_DISTRICT, WEST_HAM, "", "720.08");
    addStation(LINE_DISTRICT, BROMLEY_BY_BOW, "", "720.08");
    addStation(LINE_DISTRICT, BOW_ROAD, "", "720.08");
    addStation(LINE_DISTRICT, MILE_END, "", "720.08");
    addStation(LINE_DISTRICT, STEPNEY_GREEN, "", "");
    addStation(LINE_DISTRICT, WHITECHAPEL, "", "");
    addStation(LINE_DISTRICT, ALDGATE_EAST, "", "");
    addStation(LINE_DISTRICT, TOWER_HILL, "", "889");
    addStation(LINE_DISTRICT, MONUMENT, "", "889");
    addStation(LINE_DISTRICT, CANNON_STREET, "", "");
    addStation(LINE_DISTRICT, EMBANKMENT, "", "992");
    addStation(LINE_DISTRICT, WESTMINSTER, "", "992");
    addStation(LINE_DISTRICT, VICTORIA, "", "992");
    addStation(LINE_DISTRICT, SLOANE_SQUARE, "", "992");
    addStation(LINE_DISTRICT, SOUTH_KENSINGTON, "", "992");
    addStation(LINE_DISTRICT, EARLS_COURT, "", "992");
    addStation(LINE_DISTRICT, WEST_KENSINGTON, "", "992");
    addStation(LINE_DISTRICT, HAMMERSMITH, "", "992");
    addStation(LINE_DISTRICT, RAVENSCOURT_PARK, "", "992");
    addStation(LINE_DISTRICT, STAMFORD_BROOK, "", "992");
    addStation(LINE_DISTRICT, TURNHAM_GREEN, "", "992");
    addStation(LINE_DISTRICT, CHISWICK_PARK, "", "992");
    addStation(LINE_DISTRICT, ACTON_TOWN, "", "");
    addStation(LINE_DISTRICT, EALING_COMMON, "361.07", "");
    addStation(LINE_DISTRICT, EALING_BROADWAY, "", "");

    // District - Turnham Green to Richmond
    addStation(LINE_DISTRICT, GUNNERSBURY, "456.66", "");
    addStation(LINE_DISTRICT, KEW_GARDENS, "456.66", "");
    ...
    addStation(LINE_PICADILLY, ALPERTON, "", "");
    addStation(LINE_PICADILLY, SUDBURY_TOWN, "", "");
    addStation(LINE_PICADILLY, SUDBURY_HILL, "", "");
    addStation(LINE_PICADILLY, SOUTH_HARROW, "", "");
    addStation(LINE_PICADILLY, RAYNERS_LANE, "", "");
    addStation(LINE_PICADILLY, EASTCOTE, "", "");
    addStation(LINE_PICADILLY, RUISLIP_MANOR, "", "");
    addStation(LINE_PICADILLY, RUISLIP, "", "");
    addStation(LINE_PICADILLY, ICKENHAM, "", "");
    addStation(LINE_PICADILLY, HILLINGDON, "", "");
    addStation(LINE_PICADILLY, UXBRIDGE, "", "");

    // Picadilly - Hatton Cross to Heathrow Terminals 123
    addStation(LINE_PICADILLY, HEATHROW_TERMINAL_4, "", "");

    // Picadilly - Acton Town to Heathrow Terminal 5
    addStation(LINE_PICADILLY, SOUTH_EALING, "", "");
    addStation(LINE_PICADILLY, NORTHFIELDS, "", "");
    addStation(LINE_PICADILLY, BOSTON_MANOR, "", "");
    addStation(LINE_PICADILLY, OSTERLEY, "", "");
    addStation(LINE_PICADILLY, HOUNSLOW_EAST, "", "");
    addStation(LINE_PICADILLY, HOUNSLOW_CENTRAL, "", "");
    addStation(LINE_PICADILLY, HOUNSLOW_WEST, "", "");
    addStation(LINE_PICADILLY, HATTON_CROSS, "", "");
    addStation(LINE_PICADILLY, HEATHROW_TERMINALS_123, "", "");
    addStation(LINE_PICADILLY, HEATHROW_TERMINAL_5, "", "");
...
function addConnections() {
    ...
    joinStation(LINE_DISTRICT, WEST_KENSINGTON, HAMMERSMITH);
	...
	joinStation(LINE_PICADILLY, KNIGHTSBRIDGE, SOUTH_KENSINGTON);
	...
	joinStation(LINE_PICADILLY, SOUTH_HARROW, RAYNERS_LANE);
	joinStation(LINE_PICADILLY, RAYNERS_LANE, EASTCOTE);
	joinStation(LINE_PICADILLY, EASTCOTE, RUISLIP_MANOR);
	joinStation(LINE_PICADILLY, RUISLIP_MANOR, RUISLIP);
    ...
    // Picadilly - Hatton Cross to Heathrow Terminals 123
	joinStation(LINE_PICADILLY, HATTON_CROSS, HEATHROW_TERMINAL_4);
	joinStation(LINE_PICADILLY, HEATHROW_TERMINAL_4, HEATHROW_TERMINALS_123);

    // Picadilly - Acton Town to Heathrow Terminal 5
	joinStation(LINE_PICADILLY, ACTON_TOWN, SOUTH_EALING);
	joinStation(LINE_PICADILLY, SOUTH_EALING, NORTHFIELDS);
	joinStation(LINE_PICADILLY, NORTHFIELDS, BOSTON_MANOR);
	joinStation(LINE_PICADILLY, BOSTON_MANOR, OSTERLEY);
	joinStation(LINE_PICADILLY, OSTERLEY, HOUNSLOW_EAST);
	joinStation(LINE_PICADILLY, HOUNSLOW_EAST, HOUNSLOW_CENTRAL);
	joinStation(LINE_PICADILLY, HOUNSLOW_CENTRAL, HOUNSLOW_WEST);
	joinStation(LINE_PICADILLY, HOUNSLOW_WEST, HATTON_CROSS);
